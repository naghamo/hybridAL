"""Exp 6 — Acquisition batch size sensitivity (upgraded).
...
def make_cfg(args: argparse.Namespace, entry: dict):
    ...
    name = f"Batch_{method}_n{n}_{dataset}_seed{seed}"
    return build_cfg(
...
if __name__ == "__main__":
    parser = make_runner_parser("Exp 6 — Batch size ablation", add_extra_args)
